...
const faqItems: FAQItem[] = [
  ...
  // Investing
  {
    ...
    answer:
      'You can invest in Mutual Funds (Stanbic Cash Trust, IC Liquidity Fund, Databank MFund II), Government Treasury Bills, and US Stocks (4,000+ companies, powered by Bamboo).',
  },
  {
    id: 'investing-2',
    category: 'Investing',
